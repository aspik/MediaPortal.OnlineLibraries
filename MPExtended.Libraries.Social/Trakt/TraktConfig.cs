...
namespace MPExtended.Libraries.Social.Trakt
{
  internal class TraktConfig
  {
    ...
    public static string PluginVersion
    {
      get
      {
        return String.Format("{0} (build {1}, commit {2})", VersionUtil.GetVersionName(), VersionUtil.GetBuildVersion(),
                             VersionUtil.GetGitVersion());
      }
    }

    public static string UserAgent
    {
      get { return VersionUtil.GetUserAgent("TraktPlugin", "1.0"); }
    }
